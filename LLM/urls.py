...
urlpatterns = [
    ...
    path("voice-samples/", views.voice_samples_page, name="voice_samples_page"),
    path("api/voice-samples/", views.voice_samples_api, name="voice_samples_api"),
    path("api/voice-samples/<int:sample_id>/delete/", views.voice_sample_delete_api, name="voice_sample_delete_api"),
    path("api/vc/", views.vc_convert_api, name="vc_convert_api"),
